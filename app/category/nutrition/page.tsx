...
export default function NutritionCategory() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 px-6 bg-gradient-to-br from-green-50 to-emerald-50">
        <div className="max-w-7xl mx-auto">
          <Link href="/#categories" className="text-teal-600 hover:text-teal-700 font-semibold mb-6 inline-block">
            ← Back to Categories
          </Link>
          <h1 className="text-5xl font-bold mb-4">Personalized Nutrition & Gut Health</h1>
          <p className="text-xl text-gray-700 max-w-2xl">
            Optimize your diet based on your unique biology with cutting-edge nutritional science
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "DNA Nutrition Test Kit",
                desc: "Personalized nutrition based on your genetic profile",
                price: "$199",
                icon: "🧬"
              },
              {
                title: "Continuous Glucose Monitor",
                desc: "Real-time blood glucose tracking for optimal nutrition",
                price: "$299",
                icon: "📊"
              },
              {
                title: "Microbiome Gut Health Test",
                desc: "Analyze your microbiome and get personalized probiotics",
                price: "$179",
                icon: "🦠"
              },
              {
                title: "Personalized Meal Plans",
                desc: "AI-generated meal plans based on your data",
                price: "$29/month",
                icon: "🍽️"
              },
              {
                title: "Organic Supplement Stack",
                desc: "Science-backed supplements tailored to your needs",
                price: "$79/month",
                icon: "💊"
              },
              {
                title: "Nutrition Coaching",
                desc: "1-on-1 coaching with registered dietitians",
                price: "$199/month",
                icon: "👨‍⚕️"
              },
            ].map((product, i) => (
              <div key={i} className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
                <div className="h-48 bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center text-6xl">
                  {product.icon}
                </div>
                <div className="p-6">
      ...
      <section className="py-16 px-6 bg-teal-600">
        <div className="max-w-2xl mx-auto text-center text-white">
          <h2 className="text-3xl font-bold mb-4">Optimize Your Nutrition</h2>
          <p className="mb-6 text-teal-100">Get personalized nutrition insights and exclusive product recommendations</p>
