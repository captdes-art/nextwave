    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          <h1 className="text-6xl font-bold mb-6">Mental Wellness & Cognitive Performance</h1>
          <p className="text-xl text-gray-700 leading-relaxed">
            Boost focus, memory, and mental clarity with cutting-edge neurotechnology and cognitive enhancement tools
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            { 
              title: "Apollo Neuro", 
              price: "$349", 
              desc: "Stress relief wearable",
              image: "https://picsum.photos/seed/apollo/400/300",
              link: "#"
            },
            { 
              title: "Hapbee", 
              price: "$299", 
              desc: "Mood enhancement device",
              image: "https://picsum.photos/seed/hapbee/400/300",
              link: "#"
            },
            { 
              title: "NeurOptimal", 
              price: "$10,000", 
              desc: "Neurofeedback training",
              image: "https://picsum.photos/seed/neuroptimal/400/300",
              link: "#"
            },
            { 
              title: "Focus@Will", 
              price: "$69/year", 
              desc: "Neuroscience-based music",
              image: "https://picsum.photos/seed/focus/400/300",
              link: "#"
            },
            { 
              title: "Kernel Flow", 
              price: "TBD", 
              desc: "Brain activity monitor",
              image: "https://picsum.photos/seed/kernel/400/300",
              link: "#"
            },
          ].map((product, i) => (
            <Link 
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-xs text-gray-500 mb-4">Mental Wellness</p>
