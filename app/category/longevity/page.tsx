    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          <h1 className="text-6xl font-bold mb-6">Longevity & Anti-Aging Technologies</h1>
          <p className="text-xl text-gray-700 leading-relaxed">
            Extend healthspan with cutting-edge interventions, from red light therapy to NAD+ optimization
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            { 
              title: "Joovv Mini", 
              price: "$699", 
              desc: "Red light therapy panel",
              image: "https://picsum.photos/seed/joovv/400/300"
            },
            { 
              title: "TruDiagnostic", 
              price: "$499", 
              desc: "Biological age testing",
              image: "https://picsum.photos/seed/trudiagnostic/400/300"
            },
            { 
              title: "NAD+ IV Therapy", 
              price: "$500/session", 
              desc: "Cellular energy boost",
              image: "https://picsum.photos/seed/nad/400/300"
            },
            { 
              title: "Theragun PRO", 
              price: "$599", 
              desc: "Percussive therapy device",
              image: "https://picsum.photos/seed/theragun/400/300"
            },
            { 
              title: "NMN Supplements", 
              price: "$89/month", 
              desc: "NAD+ precursor",
              image: "https://picsum.photos/seed/nmn/400/300"
            },
            { 
              title: "Hyperbaric Chamber", 
              price: "$15,000+", 
              desc: "Oxygen therapy system",
              image: "https://picsum.photos/seed/hyperbaric/400/300"
            },
          ].map((product, i) => (
            <Link 
              key={i} 
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-xs text-gray-500 mb-4">Longevity & Anti-Aging</p>
